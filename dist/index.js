/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 358: /***/ (
      ...
      const external_child_process_namespaceObject = require("child_process"); // CONCATENATED MODULE: ./src/execute.js
  ...
  (() => {
    const core = __nccwpck_require__(186);
    const DefaultMap = __nccwpck_require__(536);
    const { runCommands } = __nccwpck_require__(358);
        ...
        if (file.includes("subgraphs/")) {
          ...
          if (file.includes("/src/")) {
            ...
            if (refFolder.includes("subgraphs")) {
              ...
              for (const protocolData of Object.values(
                DEPLOYMENT_CONFIGURATIONS
              )) {
